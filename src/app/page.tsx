        ...
        <Box className="my-16 bg-gray-900 text-white rounded-lg p-8 text-center">
          ...
          <Grid container spacing={4} className="mt-8">
            <Grid item xs={12} md={4}>
              <Box className="mb-3 flex justify-center">
                <div className="bg-gray-800 p-3 rounded-full">
                  <Image src="/api/placeholder/24/24" alt="Create icon" width={24} height={24} />
                </div>
              </Box>
            ...
            <Grid item xs={12} md={4}>
              <Box className="mb-3 flex justify-center">
                <div className="bg-gray-800 p-3 rounded-full">
                  <Image src="/api/placeholder/24/24" alt="Approve icon" width={24} height={24} />
                </div>
              </Box>
              <Typography variant="h6" className="font-medium mb-2">
            ...
            <Grid item xs={12} md={4}>
              <Box className="mb-3 flex justify-center">
                <div className="bg-gray-800 p-3 rounded-full">
                  <Image src="/api/placeholder/24/24" alt="Share icon" width={24} height={24} />
                </div>
              </Box>
              <Typography variant="h6" className="font-medium mb-2">
